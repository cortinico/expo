...
const args_js_1 = require("../utils/args.js");
const errors_js_1 = require("../utils/errors.js");
const Log = __importStar(require("../utils/log.js"));
...
const diffFingerprintsAsync = async (argv) => {
    const args = (0, args_js_1.assertArgs)({
        // Types
        '--help': Boolean,
        // Aliases
        '-h': '--help',
...
{bold Usage}
  ...
  -h, --help                           Output usage information
    ...
    const fingerprintFile1 = (0, args_js_1.getFileArgumentAtIndex)(args, 0);
    const fingerprintFile2 = (0, args_js_1.getFileArgumentAtIndex)(args, 1);
    const [fingeprint1ToDiff, fingerprint2ToDiff] = await Promise.all([
        (0, readFingerprintFileAsync_js_1.default)(fingerprintFile1),
        (0, readFingerprintFileAsync_js_1.default)(fingerprintFile2),
    ]);
    try {
        ...
        throw new errors_js_1.CommandError(e.message);
    }
};
